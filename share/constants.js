...
export const ProblemsStatuses = {
  ...
  8: 'Open - action(s) in place',
  9: 'Open - action(s) due today',
  10: 'Open - action(s) overdue',
  11: 'Open - action(s) completed',
  12: 'Open - action(s) completed, awaiting verification',
  13: 'Open - verification due today',
  14: 'Open - verification past due',
  15: 'Open - action(s) verified as effective, awaiting update of standard(s)',
  16: 'Open - action(s) verified as effective, update of standard(s) due today',
  17: 'Open - action(s) verified as effective, update of standard(s) past due',
  18: 'Open - action(s) failed verification',
