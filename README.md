...
**Note!**
1. You will need to execute the `meteor npm install` command if you you'll get a similiar error:
`Error: Can't find npm module 'handlebars'.`
This means that someone added a new npm module and you need to install it.

2. If you're getting an error *'Can't listen on port 3000. Perhaps another Meteor is running?
