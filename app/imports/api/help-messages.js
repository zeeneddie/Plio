...
const OrganizationSettingsHelp = {
  ...
  workflowSteps: 'Indicate whether you want Plio to use simple (3-step) or full (6-step) workflows for your nonconformity and risk-handling processes.  If you wish, you can set simpler workflows for your less critical non-conformities and risks.',
  workflowReminders: 'Set apppropriate reminder times for actions that become due within your nonconformity and risk-handling processes.   If you wish, you can set shorter reminder times for less critical non-conformities and risks.',
